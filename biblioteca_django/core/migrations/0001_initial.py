# Generated by Django 4.2.5 on 2023-11-10 22:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.CharField(choices=[('FIC', 'Ficción'), ('NFIC', 'No Ficción'), ('SF', 'Ciencia Ficción'), ('MYST', 'Misterio'), ('ROM', 'Romance'), ('DRAMA', 'Drama'), ('FANT', 'Fantasía'), ('BIO', 'Biografía'), ('ACAD', 'Artículos Académicos')], max_length=100)),
